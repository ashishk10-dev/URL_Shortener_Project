    ...
    <div className="min-h-[calc(100vh-64px)] lg:px-14 sm:px-8 px-4">
      <div className="lg:flex-row flex-col  lg:py-5 pt-16 lg:gap-10 gap-8 flex justify-between items-center">
        <div className="flex-1">
          ...
          className="font-bold text-slate-700 md:text-4xl sm:text-4xl text-3xl   md:leading-[55px] sm:leading-[45px] leading-10 lg:w-full md:w-[70%] w-full">
        Linklytics Simplifies URL Shortening For Efficient Sharing.
         ...
         className="text-slate-700 text-sm my-5">
          ...
          <div className="flex items-center gap-3">
            ...
            className="bg-custom-gradient border w-40 text-white rounded-md py-2">             
                Manage Links
              </motion.button>
      ...
      <div className="flex-1 flex justify-center w-full">
        ...
        <div className="sm:pt-12 pt-7">
          <p
          className="text-slate-800 font-roboto font-bold lg:w-[60%]  md:w-[70%] sm:w-[80%] mx-auto text-2xl text-center">
