    ...
    <footer className="bg-custom-gradient text-white py-8 z-40 relative">
      <div className="container mx-auto px-6 lg:px-14 flex flex-col lg:flex-row lg:justify-between items-center gap-4">
        ...
        <div className="flex space-x-6 mt-4 lg:mt-0">
          <a href="https://www.facebook.com/login/" className="hover:text-gray-200">
            <FaFacebook size={24} />
          </a>
          <a href="#" className="hover:text-gray-200">
            <FaTwitter size={24} />
          </a>
          <a href="https://www.instagram.com/accounts/login/?hl=en" className="hover:text-gray-200">
            <FaInstagram size={24} />
          </a>
          <a href="https://in.linkedin.com/?trk=guest_homepage-basic_nav-header-logo" className="hover:text-gray-200">
            <FaLinkedin size={24} />
          </a>
        </div>
      </div>
